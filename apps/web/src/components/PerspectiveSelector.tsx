...
import { getPerspective, setPerspective, PERSPECTIVE_OPTIONS, type Perspective, getUser } from '@/lib/mockAuth';
  ...
  return (
    <div className="space-y-3">
      <div>
        ...
        <p className="text-xs text-gray-500">{PERSPECTIVE_LABELS[active].subtitle}</p>
      </div>

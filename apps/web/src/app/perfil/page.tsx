...
const PERSPECTIVE_JOURNEYS: Record<Perspective, { title: string; steps: { phase: string; description: string }[] }> = {
  ...
  advogado: {
    title: 'Profissional / CRM',
    steps: [
      { phase: 'Pré', description: 'Captar ONG e empresa, validar compliance e documentos.' },
      { phase: 'Durante', description: 'Gerir relacionamento, aprovar cadastros e monitorar CRM.' },
      { phase: 'Pós', description: 'Validar prestação de contas, compliance e histórico jurídico.' },
    ],
  },
};

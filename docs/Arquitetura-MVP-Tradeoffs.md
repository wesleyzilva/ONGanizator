...
### Este é um documento legado
Este arquivo é legado e deve ser usado apenas como referência histórica. O conjunto de documentos ativos para desenvolvimento AI-first está em:
- `productBacklog/vision.md`
- `productBacklog/roadmap.md`
- `productBacklog/backlog.md`
- `productBacklog/raid-log.md`

Use estas páginas como fonte principal de verdade para o backlog e o planejamento.
